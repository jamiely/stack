...
- V4.2 collapse fail sequence: hard misses trigger a deterministic tower-topple presentation with failure camera pullback, voxelized tower explosion burst (including the missed active slab and any still-visible trimmed debris pieces), and collapse feedback cues
