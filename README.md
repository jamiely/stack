...
- V3 distraction framework with deterministic seeded state, level-gated channel activation, runtime toggle/threshold tuning hooks, on-demand debug launch triggers, and V3.2 actor visuals (gorilla climber, UFO orbit flyby around the tower + contrast wash, front-layer cloud occlusion, tremor pulse)
