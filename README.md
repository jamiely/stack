...
- Draco-compressed character assets require local decoders; this repo serves them from `public/draco/` and the runtime uses `import.meta.env.BASE_URL + "draco/"` for `DRACOLoader`.
