...
export const defaultDebugConfig: DebugConfig = {
  ...
  distractionFireworksPrimaryParticleCount: 48,
  distractionFireworksSecondaryParticleCount: 8,
  distractionFireworksRingBias: 0.2,
  distractionFireworksRadialJitter: 0.2,
  distractionFireworksVerticalBias: 0.08,
  distractionFireworksSpeedJitter: 0.14,
