...
- Unit tests cover non-rendering modules (trim/spawn/oscillation/feedback/distraction/integrity/performance/recovery/collapse/ledge/window-layout/decor-planning logic, config clamping, and non-rendering runtime services such as feedback orchestration)
