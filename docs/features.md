...
- V3.2 actor layer now renders gorilla climber + tremor pulses, a UFO that orbits around the tower with contrast-wash flashes, and front-layer cloud occlusion driven by deterministic distraction signals
