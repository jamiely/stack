...
- Landed slabs can also render scalloped eave trims near top edges for arcade-style architectural variation, on all visible sides, with slight corner micro-overlap to close seam gaps while avoiding sharp corner spikes
