...
- Character loading/normalization/placement helpers are now split out of `Game.ts` into focused `src/game/characters/*` modules so placement, scale, and retargeting bugs can be debugged without reopening the main runtime monolith
