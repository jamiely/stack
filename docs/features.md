...
- Landed slabs can also render scalloped eave trims near top edges for arcade-style architectural variation, on all visible sides, with slight corner insets to avoid sharp corner spikes
